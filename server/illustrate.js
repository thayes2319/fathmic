...
const PROMPT_SYSTEM = `You are composing a visual generation prompt for Domainify — an illustration capturing the essence of a distilled topic, for ANY subject, not decorative wall art.
