...
const SYSTEM_PROMPT = `You are the taxonomy generator for Domainify. Given a subject, produce a flat list of nodes distilling it into categories, subcategories, and concrete elements, linked by parentId.
